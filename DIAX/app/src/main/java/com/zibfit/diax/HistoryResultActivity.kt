...
//        }
    ...
    fun saveBitmap(bitmap: Bitmap) {
        imagePath = File(
            Environment.getExternalStorageDirectory().toString() + "/RACORDIAX.png"
        )
    ...
    private fun shareIt() {
        ...
        val shareBody = "RACORDIAX COVID-19 Antibody Rapid Test\n\n" +
                "Date:\n" +
                "$time\n\n" +
                "Test Number:\n" +
                "$testNumber\n\n" +
        ...
        sharingIntent.putExtra(Intent.EXTRA_SUBJECT, "RACORDIAX COVID-19 Test Result")
...
//Subject: RACORDIAX COVID-19 Test Result
//
//Content Area [not shown]:
//RACORDIAX COVID-19 Antibody Rapid Test
//
//Date:
