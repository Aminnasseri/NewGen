...
//                                    .show()
                            ...
                            runOnUiThread {
                                ...
                                view_wrong_code.visibility = View.VISIBLE
                                errorImageQr.setImageResource(R.drawable.error)
                                errorImageQr.visibility = View.VISIBLE
                    ...
                    codeScanner?.errorCallback = Camera.ErrorCallback {
    ...
    fun jsonRequest() {
        ...
        Log.i("aminoo", deviceID.toString())
        ...
        val url = "https://prod-vax.rapidtestapi.me/api/v1/user/aregister"
        ...
        val listener = Response.Listener<JSONObject> { response ->
            ...
            val TokenSharedPreferences =
                getSharedPreferences(GETINFOACT, Context.MODE_PRIVATE)
            val amin = TokenSharedPreferences.getString(TOKEN, "").toString()
